 ...
 * 
 * @export
 * @interface ContentBodyConversionInput
 */
 ...
 * @export
 */
export const ContentBodyConversionInputEmbeddedContentRenderEnum = {
    Current: 'current',
    VersionAtSave: 'version-at-save'
} as const;
export type ContentBodyConversionInputEmbeddedContentRenderEnum = typeof ContentBodyConversionInputEmbeddedContentRenderEnum[keyof typeof ContentBodyConversionInputEmbeddedContentRenderEnum];
