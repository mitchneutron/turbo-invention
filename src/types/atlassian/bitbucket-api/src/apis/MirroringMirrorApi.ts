...
export class MirroringMirrorApi extends runtime.BaseAPI {
    ...
    async getDelayedSyncRepositoriesRaw(requestParameters: GetDelayedSyncRepositoriesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<RestDelayedSyncRepository>>> {
        ...
        if (requestParameters.delayThreshold !== undefined) {
    ...
    async getMirroredRepositoryRaw(requestParameters: GetMirroredRepositoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestMirroredRepository>> {
        if (requestParameters.externalRepositoryId === null || requestParameters.externalRepositoryId === undefined) {
            throw new runtime.RequiredError('externalRepositoryId','Required parameter requestParameters.externalRepositoryId was null or undefined when calling getMirroredRepository.');
        }
    ...
    async getRepoSyncStatus1Raw(requestParameters: GetRepoSyncStatus1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestMirrorRepositorySynchronizationStatus>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling getRepoSyncStatus1.');
        }

        if (requestParameters.repositorySlug === null || requestParameters.repositorySlug === undefined) {
            throw new runtime.RequiredError('repositorySlug','Required parameter requestParameters.repositorySlug was null or undefined when calling getRepoSyncStatus1.');
        }
    ...
    async getRepositoryLockOwnerRaw(requestParameters: GetRepositoryLockOwnerRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestRepositoryLockOwner>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling getRepositoryLockOwner.');
        }

        if (requestParameters.repositorySlug === null || requestParameters.repositorySlug === undefined) {
            throw new runtime.RequiredError('repositorySlug','Required parameter requestParameters.repositorySlug was null or undefined when calling getRepositoryLockOwner.');
        }
