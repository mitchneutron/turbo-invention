...
export class BuildsAndDeploymentsApi extends runtime.BaseAPI {
    ...
    async _deleteRaw(requestParameters: DeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        if (requestParameters.commitId === null || requestParameters.commitId === undefined) {
            throw new runtime.RequiredError('commitId','Required parameter requestParameters.commitId was null or undefined when calling _delete.');
        }

        if (requestParameters.repositorySlug === null || requestParameters.repositorySlug === undefined) {
            throw new runtime.RequiredError('repositorySlug','Required parameter requestParameters.repositorySlug was null or undefined when calling _delete.');
        }

        if (requestParameters.key === null || requestParameters.key === undefined) {
            throw new runtime.RequiredError('key','Required parameter requestParameters.key was null or undefined when calling _delete.');
        }
    ...
    async addRaw(requestParameters: AddRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling add.');
        }

        if (requestParameters.commitId === null || requestParameters.commitId === undefined) {
            throw new runtime.RequiredError('commitId','Required parameter requestParameters.commitId was null or undefined when calling add.');
        }

        if (requestParameters.repositorySlug === null || requestParameters.repositorySlug === undefined) {
            throw new runtime.RequiredError('repositorySlug','Required parameter requestParameters.repositorySlug was null or undefined when calling add.');
        }
    ...
    async addAnnotationsRaw(requestParameters: AddAnnotationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling addAnnotations.');
        }

        if (requestParameters.commitId === null || requestParameters.commitId === undefined) {
            throw new runtime.RequiredError('commitId','Required parameter requestParameters.commitId was null or undefined when calling addAnnotations.');
        }

        if (requestParameters.repositorySlug === null || requestParameters.repositorySlug === undefined) {
            throw new runtime.RequiredError('repositorySlug','Required parameter requestParameters.repositorySlug was null or undefined when calling addAnnotations.');
        }

        if (requestParameters.key === null || requestParameters.key === undefined) {
            throw new runtime.RequiredError('key','Required parameter requestParameters.key was null or undefined when calling addAnnotations.');
        }
    ...
    async createOrUpdateDeploymentRaw(requestParameters: CreateOrUpdateDeploymentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestDeployment>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling createOrUpdateDeployment.');
        }

        if (requestParameters.commitId === null || requestParameters.commitId === undefined) {
            throw new runtime.RequiredError('commitId','Required parameter requestParameters.commitId was null or undefined when calling createOrUpdateDeployment.');
        }

        if (requestParameters.repositorySlug === null || requestParameters.repositorySlug === undefined) {
            throw new runtime.RequiredError('repositorySlug','Required parameter requestParameters.repositorySlug was null or undefined when calling createOrUpdateDeployment.');
        }
    ...
    async createRequiredBuildsMergeCheckRaw(requestParameters: CreateRequiredBuildsMergeCheckRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestRequiredBuildCondition>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling createRequiredBuildsMergeCheck.');
        }

        if (requestParameters.repositorySlug === null || requestParameters.repositorySlug === undefined) {
            throw new runtime.RequiredError('repositorySlug','Required parameter requestParameters.repositorySlug was null or undefined when calling createRequiredBuildsMergeCheck.');
        }
    ...
    async delete1Raw(requestParameters: Delete1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        if (requestParameters.commitId === null || requestParameters.commitId === undefined) {
            throw new runtime.RequiredError('commitId','Required parameter requestParameters.commitId was null or undefined when calling delete1.');
        }
        ...
        if (requestParameters.deploymentSequenceNumber !== undefined) {
        ...
        if (requestParameters.environmentKey !== undefined) {
    ...
    async deleteACodeInsightsReportRaw(requestParameters: DeleteACodeInsightsReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling deleteACodeInsightsReport.');
        }

        if (requestParameters.commitId === null || requestParameters.commitId === undefined) {
            throw new runtime.RequiredError('commitId','Required parameter requestParameters.commitId was null or undefined when calling deleteACodeInsightsReport.');
        }

        if (requestParameters.repositorySlug === null || requestParameters.repositorySlug === undefined) {
            throw new runtime.RequiredError('repositorySlug','Required parameter requestParameters.repositorySlug was null or undefined when calling deleteACodeInsightsReport.');
        }

        if (requestParameters.key === null || requestParameters.key === undefined) {
            throw new runtime.RequiredError('key','Required parameter requestParameters.key was null or undefined when calling deleteACodeInsightsReport.');
        }
    ...
    async deleteAnnotationsRaw(requestParameters: DeleteAnnotationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling deleteAnnotations.');
        }

        if (requestParameters.commitId === null || requestParameters.commitId === undefined) {
            throw new runtime.RequiredError('commitId','Required parameter requestParameters.commitId was null or undefined when calling deleteAnnotations.');
        }

        if (requestParameters.repositorySlug === null || requestParameters.repositorySlug === undefined) {
            throw new runtime.RequiredError('repositorySlug','Required parameter requestParameters.repositorySlug was null or undefined when calling deleteAnnotations.');
        }

        if (requestParameters.key === null || requestParameters.key === undefined) {
            throw new runtime.RequiredError('key','Required parameter requestParameters.key was null or undefined when calling deleteAnnotations.');
        }
    ...
    async deleteRequiredBuildsMergeCheckRaw(requestParameters: DeleteRequiredBuildsMergeCheckRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling deleteRequiredBuildsMergeCheck.');
        }

        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling deleteRequiredBuildsMergeCheck.');
        }

        if (requestParameters.repositorySlug === null || requestParameters.repositorySlug === undefined) {
            throw new runtime.RequiredError('repositorySlug','Required parameter requestParameters.repositorySlug was null or undefined when calling deleteRequiredBuildsMergeCheck.');
        }
    ...
    async getRaw(requestParameters: GetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestBuildStatus>> {
        ...
        if (requestParameters.commitId === null || requestParameters.commitId === undefined) {
            throw new runtime.RequiredError('commitId','Required parameter requestParameters.commitId was null or undefined when calling get.');
        }

        if (requestParameters.repositorySlug === null || requestParameters.repositorySlug === undefined) {
            throw new runtime.RequiredError('repositorySlug','Required parameter requestParameters.repositorySlug was null or undefined when calling get.');
        }
    ...
    async get1Raw(requestParameters: Get1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestDeployment>> {
        ...
        if (requestParameters.commitId === null || requestParameters.commitId === undefined) {
            throw new runtime.RequiredError('commitId','Required parameter requestParameters.commitId was null or undefined when calling get1.');
        }
    ...
    async getACodeInsightsReportRaw(requestParameters: GetACodeInsightsReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestInsightReport>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling getACodeInsightsReport.');
        }

        if (requestParameters.commitId === null || requestParameters.commitId === undefined) {
            throw new runtime.RequiredError('commitId','Required parameter requestParameters.commitId was null or undefined when calling getACodeInsightsReport.');
        }

        if (requestParameters.repositorySlug === null || requestParameters.repositorySlug === undefined) {
            throw new runtime.RequiredError('repositorySlug','Required parameter requestParameters.repositorySlug was null or undefined when calling getACodeInsightsReport.');
        }

        if (requestParameters.key === null || requestParameters.key === undefined) {
            throw new runtime.RequiredError('key','Required parameter requestParameters.key was null or undefined when calling getACodeInsightsReport.');
        }
    ...
    async getAnnotationsRaw(requestParameters: GetAnnotationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestInsightAnnotationsResponse>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling getAnnotations.');
        }

        if (requestParameters.commitId === null || requestParameters.commitId === undefined) {
            throw new runtime.RequiredError('commitId','Required parameter requestParameters.commitId was null or undefined when calling getAnnotations.');
        }

        if (requestParameters.repositorySlug === null || requestParameters.repositorySlug === undefined) {
            throw new runtime.RequiredError('repositorySlug','Required parameter requestParameters.repositorySlug was null or undefined when calling getAnnotations.');
        }

        if (requestParameters.key === null || requestParameters.key === undefined) {
            throw new runtime.RequiredError('key','Required parameter requestParameters.key was null or undefined when calling getAnnotations.');
        }
    ...
    async getAnnotations1Raw(requestParameters: GetAnnotations1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestInsightAnnotationsResponse>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling getAnnotations1.');
        }

        if (requestParameters.commitId === null || requestParameters.commitId === undefined) {
            throw new runtime.RequiredError('commitId','Required parameter requestParameters.commitId was null or undefined when calling getAnnotations1.');
        }

        if (requestParameters.repositorySlug === null || requestParameters.repositorySlug === undefined) {
            throw new runtime.RequiredError('repositorySlug','Required parameter requestParameters.repositorySlug was null or undefined when calling getAnnotations1.');
        }
    ...
    async getPageOfRequiredBuildsMergeChecksRaw(requestParameters: GetPageOfRequiredBuildsMergeChecksRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetPageOfRequiredBuildsMergeChecks200Response>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling getPageOfRequiredBuildsMergeChecks.');
        }

        if (requestParameters.repositorySlug === null || requestParameters.repositorySlug === undefined) {
            throw new runtime.RequiredError('repositorySlug','Required parameter requestParameters.repositorySlug was null or undefined when calling getPageOfRequiredBuildsMergeChecks.');
        }
    ...
    async getReportsRaw(requestParameters: GetReportsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetReports200Response>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling getReports.');
        }

        if (requestParameters.commitId === null || requestParameters.commitId === undefined) {
            throw new runtime.RequiredError('commitId','Required parameter requestParameters.commitId was null or undefined when calling getReports.');
        }

        if (requestParameters.repositorySlug === null || requestParameters.repositorySlug === undefined) {
            throw new runtime.RequiredError('repositorySlug','Required parameter requestParameters.repositorySlug was null or undefined when calling getReports.');
        }
    ...
    async setACodeInsightsReportRaw(requestParameters: SetACodeInsightsReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestInsightReport>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling setACodeInsightsReport.');
        }

        if (requestParameters.commitId === null || requestParameters.commitId === undefined) {
            throw new runtime.RequiredError('commitId','Required parameter requestParameters.commitId was null or undefined when calling setACodeInsightsReport.');
        }

        if (requestParameters.repositorySlug === null || requestParameters.repositorySlug === undefined) {
            throw new runtime.RequiredError('repositorySlug','Required parameter requestParameters.repositorySlug was null or undefined when calling setACodeInsightsReport.');
        }

        if (requestParameters.key === null || requestParameters.key === undefined) {
            throw new runtime.RequiredError('key','Required parameter requestParameters.key was null or undefined when calling setACodeInsightsReport.');
        }
    ...
    async setAnnotationRaw(requestParameters: SetAnnotationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling setAnnotation.');
        }

        if (requestParameters.externalId === null || requestParameters.externalId === undefined) {
            throw new runtime.RequiredError('externalId','Required parameter requestParameters.externalId was null or undefined when calling setAnnotation.');
        }

        if (requestParameters.commitId === null || requestParameters.commitId === undefined) {
            throw new runtime.RequiredError('commitId','Required parameter requestParameters.commitId was null or undefined when calling setAnnotation.');
        }

        if (requestParameters.repositorySlug === null || requestParameters.repositorySlug === undefined) {
            throw new runtime.RequiredError('repositorySlug','Required parameter requestParameters.repositorySlug was null or undefined when calling setAnnotation.');
        }

        if (requestParameters.key === null || requestParameters.key === undefined) {
            throw new runtime.RequiredError('key','Required parameter requestParameters.key was null or undefined when calling setAnnotation.');
        }
    ...
    async updateRequiredBuildsMergeCheckRaw(requestParameters: UpdateRequiredBuildsMergeCheckRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestRequiredBuildCondition>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling updateRequiredBuildsMergeCheck.');
        }

        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling updateRequiredBuildsMergeCheck.');
        }

        if (requestParameters.repositorySlug === null || requestParameters.repositorySlug === undefined) {
            throw new runtime.RequiredError('repositorySlug','Required parameter requestParameters.repositorySlug was null or undefined when calling updateRequiredBuildsMergeCheck.');
        }
