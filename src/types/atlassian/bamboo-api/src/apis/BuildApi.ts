...
export class BuildApi extends runtime.BaseAPI {
    ...
    async addPlanLabelRaw(requestParameters: AddPlanLabelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling addPlanLabel.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling addPlanLabel.');
        }

        if (requestParameters.restPlanLabel === null || requestParameters.restPlanLabel === undefined) {
            throw new runtime.RequiredError('restPlanLabel','Required parameter requestParameters.restPlanLabel was null or undefined when calling addPlanLabel.');
        }
    ...
    async addPlanVariableRaw(requestParameters: AddPlanVariableRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestVariable>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling addPlanVariable.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling addPlanVariable.');
        }

        if (requestParameters.restVariable === null || requestParameters.restVariable === undefined) {
            throw new runtime.RequiredError('restVariable','Required parameter requestParameters.restVariable was null or undefined when calling addPlanVariable.');
        }
    ...
    async createNewBranchRaw(requestParameters: CreateNewBranchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestPlanBranch>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling createNewBranch.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling createNewBranch.');
        }

        if (requestParameters.branchName === null || requestParameters.branchName === undefined) {
            throw new runtime.RequiredError('branchName','Required parameter requestParameters.branchName was null or undefined when calling createNewBranch.');
        }

        const queryParameters: any = {};

        if (requestParameters.cleanupEnabled !== undefined) {
            queryParameters['cleanupEnabled'] = requestParameters.cleanupEnabled;
        }

        if (requestParameters.vcsBranch !== undefined) {
    ...
    async deletePlanRaw(requestParameters: DeletePlanRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling deletePlan.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling deletePlan.');
        }
    ...
    async deletePlanVariableRaw(requestParameters: DeletePlanVariableRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling deletePlanVariable.');
        }

        if (requestParameters.variableName === null || requestParameters.variableName === undefined) {
            throw new runtime.RequiredError('variableName','Required parameter requestParameters.variableName was null or undefined when calling deletePlanVariable.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling deletePlanVariable.');
        }
    ...
    async disablePlanRaw(requestParameters: DisablePlanRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling disablePlan.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling disablePlan.');
        }
    ...
    async editPlanVariableRaw(requestParameters: EditPlanVariableRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestVariable>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling editPlanVariable.');
        }

        if (requestParameters.variableName === null || requestParameters.variableName === undefined) {
            throw new runtime.RequiredError('variableName','Required parameter requestParameters.variableName was null or undefined when calling editPlanVariable.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling editPlanVariable.');
        }

        if (requestParameters.restVariable === null || requestParameters.restVariable === undefined) {
            throw new runtime.RequiredError('restVariable','Required parameter requestParameters.restVariable was null or undefined when calling editPlanVariable.');
        }
    ...
    async enablePlanRaw(requestParameters: EnablePlanRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling enablePlan.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling enablePlan.');
        }
    ...
    async enableSpecsForBranchesRaw(requestParameters: EnableSpecsForBranchesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling enableSpecsForBranches.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling enableSpecsForBranches.');
        }
    ...
    async exportPlanSpecRaw(requestParameters: ExportPlanSpecRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling exportPlanSpec.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling exportPlanSpec.');
        }
    ...
    async getDockerPipelineConfigurationRaw(requestParameters: GetDockerPipelineConfigurationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestDockerPipelineConfiguration>> {
        if (requestParameters.jobKey === null || requestParameters.jobKey === undefined) {
            throw new runtime.RequiredError('jobKey','Required parameter requestParameters.jobKey was null or undefined when calling getDockerPipelineConfiguration.');
        }
    ...
    async getIssueDetailsRaw(requestParameters: GetIssueDetailsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestJiraIssue>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling getIssueDetails.');
        }

        if (requestParameters.issueKey === null || requestParameters.issueKey === undefined) {
            throw new runtime.RequiredError('issueKey','Required parameter requestParameters.issueKey was null or undefined when calling getIssueDetails.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling getIssueDetails.');
        }
    ...
    async getPlanRaw(requestParameters: GetPlanRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestPlan>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling getPlan.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling getPlan.');
        }
    ...
    async getPlanAliasRaw(requestParameters: GetPlanAliasRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestPlan>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling getPlanAlias.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling getPlanAlias.');
        }
    ...
    async getPlanArtifactDefinitionRaw(requestParameters: GetPlanArtifactDefinitionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestArtifactDefinitions>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling getPlanArtifactDefinition.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling getPlanArtifactDefinition.');
        }
    ...
    async getPlanBranchRaw(requestParameters: GetPlanBranchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestPlanBranch>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling getPlanBranch.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling getPlanBranch.');
        }

        if (requestParameters.branchName === null || requestParameters.branchName === undefined) {
            throw new runtime.RequiredError('branchName','Required parameter requestParameters.branchName was null or undefined when calling getPlanBranch.');
        }
    ...
    async getPlanBranchesRaw(requestParameters: GetPlanBranchesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling getPlanBranches.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling getPlanBranches.');
        }

        const queryParameters: any = {};

        if (requestParameters.enabledOnly !== undefined) {
            queryParameters['enabledOnly'] = requestParameters.enabledOnly;
        }

        if (requestParameters.cloverEnabled !== undefined) {
    ...
    async getPlanDirectoryRaw(requestParameters: GetPlanDirectoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DirectoryInformationResponse>> {
        if (requestParameters.planKey === null || requestParameters.planKey === undefined) {
            throw new runtime.RequiredError('planKey','Required parameter requestParameters.planKey was null or undefined when calling getPlanDirectory.');
        }
    ...
    async getPlanLabelsRaw(requestParameters: GetPlanLabelsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestBuildLabels>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling getPlanLabels.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling getPlanLabels.');
        }
    ...
    async getPlanVariableRaw(requestParameters: GetPlanVariableRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestVariable>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling getPlanVariable.');
        }

        if (requestParameters.variableName === null || requestParameters.variableName === undefined) {
            throw new runtime.RequiredError('variableName','Required parameter requestParameters.variableName was null or undefined when calling getPlanVariable.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling getPlanVariable.');
        }
    ...
    async getPlanVariablesRaw(requestParameters: GetPlanVariablesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling getPlanVariables.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling getPlanVariables.');
        }
    ...
    async getVcsBranchesRaw(requestParameters: GetVcsBranchesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling getVcsBranches.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling getVcsBranches.');
        }
    ...
    async markPlanFavouriteRaw(requestParameters: MarkPlanFavouriteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling markPlanFavourite.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling markPlanFavourite.');
        }
    ...
    async quarantineTestRaw(requestParameters: QuarantineTestRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling quarantineTest.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling quarantineTest.');
        }

        if (requestParameters.testId === null || requestParameters.testId === undefined) {
            throw new runtime.RequiredError('testId','Required parameter requestParameters.testId was null or undefined when calling quarantineTest.');
        }
    ...
    async removePlanLabelRaw(requestParameters: RemovePlanLabelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling removePlanLabel.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling removePlanLabel.');
        }

        if (requestParameters.labelName === null || requestParameters.labelName === undefined) {
            throw new runtime.RequiredError('labelName','Required parameter requestParameters.labelName was null or undefined when calling removePlanLabel.');
        }
    ...
    async setDockerPipelineConfigurationRaw(requestParameters: SetDockerPipelineConfigurationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.jobKey === null || requestParameters.jobKey === undefined) {
            throw new runtime.RequiredError('jobKey','Required parameter requestParameters.jobKey was null or undefined when calling setDockerPipelineConfiguration.');
        }

        if (requestParameters.restDockerPipelineConfiguration === null || requestParameters.restDockerPipelineConfiguration === undefined) {
            throw new runtime.RequiredError('restDockerPipelineConfiguration','Required parameter requestParameters.restDockerPipelineConfiguration was null or undefined when calling setDockerPipelineConfiguration.');
        }
    ...
    async unleashTestRaw(requestParameters: UnleashTestRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling unleashTest.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling unleashTest.');
        }

        if (requestParameters.testId === null || requestParameters.testId === undefined) {
            throw new runtime.RequiredError('testId','Required parameter requestParameters.testId was null or undefined when calling unleashTest.');
        }
    ...
    async unmarkPlanFavouriteRaw(requestParameters: UnmarkPlanFavouriteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling unmarkPlanFavourite.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling unmarkPlanFavourite.');
        }
