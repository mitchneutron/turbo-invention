...
export class TrustedKeysManagementApi extends runtime.BaseAPI {
    ...
    async createRaw(requestParameters: CreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestTrustedKey>> {
        if (requestParameters.restTrustedKey === null || requestParameters.restTrustedKey === undefined) {
            throw new runtime.RequiredError('restTrustedKey','Required parameter requestParameters.restTrustedKey was null or undefined when calling create.');
        }
