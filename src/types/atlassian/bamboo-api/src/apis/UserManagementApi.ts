...
export class UserManagementApi extends runtime.BaseAPI {
    ...
    async addUsersToGroupRaw(requestParameters: AddUsersToGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling addUsersToGroup.');
        }
    ...
    async assignGroupsRaw(requestParameters: AssignGroupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling assignGroups.');
        }

        if (requestParameters.requestBody === null || requestParameters.requestBody === undefined) {
            throw new runtime.RequiredError('requestBody','Required parameter requestParameters.requestBody was null or undefined when calling assignGroups.');
        }
    ...
    async changeUserPasswordRaw(requestParameters: ChangeUserPasswordRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.restUserPasswordUpdate === null || requestParameters.restUserPasswordUpdate === undefined) {
            throw new runtime.RequiredError('restUserPasswordUpdate','Required parameter requestParameters.restUserPasswordUpdate was null or undefined when calling changeUserPassword.');
        }
    ...
    async createGroup1Raw(requestParameters: CreateGroup1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.restGroup === null || requestParameters.restGroup === undefined) {
            throw new runtime.RequiredError('restGroup','Required parameter requestParameters.restGroup was null or undefined when calling createGroup1.');
        }
    ...
    async createUserRaw(requestParameters: CreateUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.restNewUser === null || requestParameters.restNewUser === undefined) {
            throw new runtime.RequiredError('restNewUser','Required parameter requestParameters.restNewUser was null or undefined when calling createUser.');
        }
    ...
    async createUserRepositoryAliasRaw(requestParameters: CreateUserRepositoryAliasRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling createUserRepositoryAlias.');
        }

        if (requestParameters.requestBody === null || requestParameters.requestBody === undefined) {
            throw new runtime.RequiredError('requestBody','Required parameter requestParameters.requestBody was null or undefined when calling createUserRepositoryAlias.');
        }
    ...
    async findAssignedGroupsRaw(requestParameters: FindAssignedGroupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetGroups200Response>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling findAssignedGroups.');
        }
    ...
    async findUnassignedGroupsRaw(requestParameters: FindUnassignedGroupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetGroups200Response>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling findUnassignedGroups.');
        }
    ...
    async findUnassignedUserRepositoryAliasesRaw(requestParameters: FindUnassignedUserRepositoryAliasesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetUserRepositoryAliases200Response>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling findUnassignedUserRepositoryAliases.');
        }
    ...
    async findUsersInGroupRaw(requestParameters: FindUsersInGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FindUsersInGroup200Response>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling findUsersInGroup.');
        }
    ...
    async findUsersNotInGroupRaw(requestParameters: FindUsersNotInGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FindUsersInGroup200Response>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling findUsersNotInGroup.');
        }
    ...
    async getUserAccessTokensRaw(requestParameters: GetUserAccessTokensRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetUserTokens200Response>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling getUserAccessTokens.');
        }
    ...
    async getUserRepositoryAliasesRaw(requestParameters: GetUserRepositoryAliasesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetUserRepositoryAliases200Response>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling getUserRepositoryAliases.');
        }
    ...
    async removeUsersFromGroupRaw(requestParameters: RemoveUsersFromGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling removeUsersFromGroup.');
        }
    ...
    async renameUserRaw(requestParameters: RenameUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.restUserRenameRequest === null || requestParameters.restUserRenameRequest === undefined) {
            throw new runtime.RequiredError('restUserRenameRequest','Required parameter requestParameters.restUserRenameRequest was null or undefined when calling renameUser.');
        }
    ...
    async renameUserPostRaw(requestParameters: RenameUserPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.restUserRenameRequest === null || requestParameters.restUserRenameRequest === undefined) {
            throw new runtime.RequiredError('restUserRenameRequest','Required parameter requestParameters.restUserRenameRequest was null or undefined when calling renameUserPost.');
        }

        const queryParameters: any = {};

        if (requestParameters.externalRename !== undefined) {
    ...
    async renameUserPutRaw(requestParameters: RenameUserPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.newUserName === null || requestParameters.newUserName === undefined) {
            throw new runtime.RequiredError('newUserName','Required parameter requestParameters.newUserName was null or undefined when calling renameUserPut.');
        }

        if (requestParameters.restUserRenameRequest === null || requestParameters.restUserRenameRequest === undefined) {
            throw new runtime.RequiredError('restUserRenameRequest','Required parameter requestParameters.restUserRenameRequest was null or undefined when calling renameUserPut.');
        }
    ...
    async revokeUserTokenRaw(requestParameters: RevokeUserTokenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.tokenId === null || requestParameters.tokenId === undefined) {
            throw new runtime.RequiredError('tokenId','Required parameter requestParameters.tokenId was null or undefined when calling revokeUserToken.');
        }

        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling revokeUserToken.');
        }
    ...
    async unassignGroupsRaw(requestParameters: UnassignGroupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling unassignGroups.');
        }

        if (requestParameters.requestBody === null || requestParameters.requestBody === undefined) {
            throw new runtime.RequiredError('requestBody','Required parameter requestParameters.requestBody was null or undefined when calling unassignGroups.');
        }
    ...
    async unlinkUserRepositoryAliasRaw(requestParameters: UnlinkUserRepositoryAliasRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling unlinkUserRepositoryAlias.');
        }

        if (requestParameters.restUserAlias === null || requestParameters.restUserAlias === undefined) {
            throw new runtime.RequiredError('restUserAlias','Required parameter requestParameters.restUserAlias was null or undefined when calling unlinkUserRepositoryAlias.');
        }
