...
export class DefaultApi extends runtime.BaseAPI {
    ...
    async createProjectRaw(requestParameters: CreateProjectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestProjectCreate>> {
        if (requestParameters.restProjectCreate === null || requestParameters.restProjectCreate === undefined) {
            throw new runtime.RequiredError('restProjectCreate','Required parameter requestParameters.restProjectCreate was null or undefined when calling createProject.');
        }
    ...
    async getAgentAutomaticManagementConfigurationRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestRemoteAgentConfiguration>> {
        ...
        const response = await this.request({
            path: `/admin/latest/config/agents/offlineAgentRemoval`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async getDeploymentProjectVersionsListRaw(requestParameters: GetDeploymentProjectVersionsListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.deploymentProjectId === null || requestParameters.deploymentProjectId === undefined) {
            throw new runtime.RequiredError('deploymentProjectId','Required parameter requestParameters.deploymentProjectId was null or undefined when calling getDeploymentProjectVersionsList.');
        }
    ...
    async getLatestVersionStatusesRaw(requestParameters: GetLatestVersionStatusesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestDeploymentVersionStatuses>> {
        if (requestParameters.deploymentVersionId === null || requestParameters.deploymentVersionId === undefined) {
            throw new runtime.RequiredError('deploymentVersionId','Required parameter requestParameters.deploymentVersionId was null or undefined when calling getLatestVersionStatuses.');
        }
     ...
     * Get the all users\' latest statuses of deployment version.
     */
    async getLatestVersionStatuses(requestParameters: GetLatestVersionStatusesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RestDeploymentVersionStatuses> {
    ...
    async put1Raw(requestParameters: Put1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestUserDarkFeature>> {
        if (requestParameters.userName === null || requestParameters.userName === undefined) {
            throw new runtime.RequiredError('userName','Required parameter requestParameters.userName was null or undefined when calling put1.');
        }
    ...
    async startBuild1Raw(requestParameters: StartBuild1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestQueuedBuild>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling startBuild1.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling startBuild1.');
        }
    ...
    async triggerSpecsScanningRaw(requestParameters: TriggerSpecsScanningRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.repositoryId === null || requestParameters.repositoryId === undefined) {
            throw new runtime.RequiredError('repositoryId','Required parameter requestParameters.repositoryId was null or undefined when calling triggerSpecsScanning.');
        }
