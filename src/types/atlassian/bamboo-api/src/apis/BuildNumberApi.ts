...
export class BuildNumberApi extends runtime.BaseAPI {
    ...
    async bumpBuildNumberRaw(requestParameters: BumpBuildNumberRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling bumpBuildNumber.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling bumpBuildNumber.');
        }

        if (requestParameters.nextBuildNumber === null || requestParameters.nextBuildNumber === undefined) {
            throw new runtime.RequiredError('nextBuildNumber','Required parameter requestParameters.nextBuildNumber was null or undefined when calling bumpBuildNumber.');
        }
    ...
    async getNextBuildNumberRaw(requestParameters: GetNextBuildNumberRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<NextBuildNumber>> {
        if (requestParameters.projectKey === null || requestParameters.projectKey === undefined) {
            throw new runtime.RequiredError('projectKey','Required parameter requestParameters.projectKey was null or undefined when calling getNextBuildNumber.');
        }

        if (requestParameters.buildKey === null || requestParameters.buildKey === undefined) {
            throw new runtime.RequiredError('buildKey','Required parameter requestParameters.buildKey was null or undefined when calling getNextBuildNumber.');
        }
