...
export interface GetFolderAncestorsRequest {
    id: number;
    limit?: number;
}
...
export class AncestorsApi extends runtime.BaseAPI {
    ...
    async getDatabaseAncestorsRaw(requestParameters: GetDatabaseAncestorsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiEntityResultAncestor>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling getDatabaseAncestors.');
        }
     ...
     */
    async getFolderAncestorsRaw(requestParameters: GetFolderAncestorsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiEntityResultAncestor>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling getFolderAncestors.');
        }
     ...
     * Get all ancestors of folder
     */
    async getFolderAncestors(requestParameters: GetFolderAncestorsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MultiEntityResultAncestor> {
        const response = await this.getFolderAncestorsRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async getSmartLinkAncestorsRaw(requestParameters: GetSmartLinkAncestorsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiEntityResultAncestor>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling getSmartLinkAncestors.');
        }
    ...
    async getWhiteboardAncestorsRaw(requestParameters: GetWhiteboardAncestorsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiEntityResultAncestor>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling getWhiteboardAncestors.');
        }
