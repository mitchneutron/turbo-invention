...
export class ClassificationLevelApi extends runtime.BaseAPI {
    ...
    async deleteSpaceDefaultClassificationLevelRaw(requestParameters: DeleteSpaceDefaultClassificationLevelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling deleteSpaceDefaultClassificationLevel.');
        }
    ...
    async getBlogPostClassificationLevelRaw(requestParameters: GetBlogPostClassificationLevelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ClassificationLevel>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling getBlogPostClassificationLevel.');
        }
    ...
    async getDatabaseClassificationLevelRaw(requestParameters: GetDatabaseClassificationLevelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ClassificationLevel>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling getDatabaseClassificationLevel.');
        }
    ...
    async getPageClassificationLevelRaw(requestParameters: GetPageClassificationLevelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ClassificationLevel>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling getPageClassificationLevel.');
        }
    ...
    async getSpaceDefaultClassificationLevelRaw(requestParameters: GetSpaceDefaultClassificationLevelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ClassificationLevel>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling getSpaceDefaultClassificationLevel.');
        }
    ...
    async getWhiteboardClassificationLevelRaw(requestParameters: GetWhiteboardClassificationLevelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ClassificationLevel>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling getWhiteboardClassificationLevel.');
        }
    ...
    async postBlogPostClassificationLevelRaw(requestParameters: PostBlogPostClassificationLevelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling postBlogPostClassificationLevel.');
        }

        if (requestParameters.postPageClassificationLevelRequest === null || requestParameters.postPageClassificationLevelRequest === undefined) {
            throw new runtime.RequiredError('postPageClassificationLevelRequest','Required parameter requestParameters.postPageClassificationLevelRequest was null or undefined when calling postBlogPostClassificationLevel.');
        }
    ...
    async postDatabaseClassificationLevelRaw(requestParameters: PostDatabaseClassificationLevelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling postDatabaseClassificationLevel.');
        }

        if (requestParameters.postWhiteboardClassificationLevelRequest === null || requestParameters.postWhiteboardClassificationLevelRequest === undefined) {
            throw new runtime.RequiredError('postWhiteboardClassificationLevelRequest','Required parameter requestParameters.postWhiteboardClassificationLevelRequest was null or undefined when calling postDatabaseClassificationLevel.');
        }
    ...
    async postPageClassificationLevelRaw(requestParameters: PostPageClassificationLevelOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling postPageClassificationLevel.');
        }

        if (requestParameters.postPageClassificationLevelRequest === null || requestParameters.postPageClassificationLevelRequest === undefined) {
            throw new runtime.RequiredError('postPageClassificationLevelRequest','Required parameter requestParameters.postPageClassificationLevelRequest was null or undefined when calling postPageClassificationLevel.');
        }
    ...
    async postWhiteboardClassificationLevelRaw(requestParameters: PostWhiteboardClassificationLevelOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling postWhiteboardClassificationLevel.');
        }

        if (requestParameters.postWhiteboardClassificationLevelRequest === null || requestParameters.postWhiteboardClassificationLevelRequest === undefined) {
            throw new runtime.RequiredError('postWhiteboardClassificationLevelRequest','Required parameter requestParameters.postWhiteboardClassificationLevelRequest was null or undefined when calling postWhiteboardClassificationLevel.');
        }
    ...
    async putBlogPostClassificationLevelRaw(requestParameters: PutBlogPostClassificationLevelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling putBlogPostClassificationLevel.');
        }

        if (requestParameters.putPageClassificationLevelRequest === null || requestParameters.putPageClassificationLevelRequest === undefined) {
            throw new runtime.RequiredError('putPageClassificationLevelRequest','Required parameter requestParameters.putPageClassificationLevelRequest was null or undefined when calling putBlogPostClassificationLevel.');
        }
    ...
    async putDatabaseClassificationLevelRaw(requestParameters: PutDatabaseClassificationLevelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling putDatabaseClassificationLevel.');
        }

        if (requestParameters.putWhiteboardClassificationLevelRequest === null || requestParameters.putWhiteboardClassificationLevelRequest === undefined) {
            throw new runtime.RequiredError('putWhiteboardClassificationLevelRequest','Required parameter requestParameters.putWhiteboardClassificationLevelRequest was null or undefined when calling putDatabaseClassificationLevel.');
        }
    ...
    async putPageClassificationLevelRaw(requestParameters: PutPageClassificationLevelOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling putPageClassificationLevel.');
        }

        if (requestParameters.putPageClassificationLevelRequest === null || requestParameters.putPageClassificationLevelRequest === undefined) {
            throw new runtime.RequiredError('putPageClassificationLevelRequest','Required parameter requestParameters.putPageClassificationLevelRequest was null or undefined when calling putPageClassificationLevel.');
        }
    ...
    async putSpaceDefaultClassificationLevelRaw(requestParameters: PutSpaceDefaultClassificationLevelOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling putSpaceDefaultClassificationLevel.');
        }

        if (requestParameters.putSpaceDefaultClassificationLevelRequest === null || requestParameters.putSpaceDefaultClassificationLevelRequest === undefined) {
            throw new runtime.RequiredError('putSpaceDefaultClassificationLevelRequest','Required parameter requestParameters.putSpaceDefaultClassificationLevelRequest was null or undefined when calling putSpaceDefaultClassificationLevel.');
        }
    ...
    async putWhiteboardClassificationLevelRaw(requestParameters: PutWhiteboardClassificationLevelOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling putWhiteboardClassificationLevel.');
        }

        if (requestParameters.putWhiteboardClassificationLevelRequest === null || requestParameters.putWhiteboardClassificationLevelRequest === undefined) {
            throw new runtime.RequiredError('putWhiteboardClassificationLevelRequest','Required parameter requestParameters.putWhiteboardClassificationLevelRequest was null or undefined when calling putWhiteboardClassificationLevel.');
        }
