...
export class PageApi extends runtime.BaseAPI {
    ...
    async createPageRaw(requestParameters: CreatePageOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreatePage200Response>> {
        ...
        if (requestParameters.rootLevel !== undefined) {
    ...
    async updatePageTitleRaw(requestParameters: UpdatePageTitleOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreatePage200Response>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling updatePageTitle.');
        }

        if (requestParameters.updatePageTitleRequest === null || requestParameters.updatePageTitleRequest === undefined) {
            throw new runtime.RequiredError('updatePageTitleRequest','Required parameter requestParameters.updatePageTitleRequest was null or undefined when calling updatePageTitle.');
        }
        ...
        const response = await this.request({
            path: `/pages/{id}/title`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
