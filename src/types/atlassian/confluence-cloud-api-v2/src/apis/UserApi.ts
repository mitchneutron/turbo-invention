...
export class UserApi extends runtime.BaseAPI {
    ...
    async createBulkUserLookupRaw(requestParameters: CreateBulkUserLookupOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiEntityResultUser>> {
        if (requestParameters.createBulkUserLookupRequest === null || requestParameters.createBulkUserLookupRequest === undefined) {
            throw new runtime.RequiredError('createBulkUserLookupRequest','Required parameter requestParameters.createBulkUserLookupRequest was null or undefined when calling createBulkUserLookup.');
        }
